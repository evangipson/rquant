...
/// which will provide the [`Debug`](crate::logger::types::logger::LogSeverity::Debug) log severity level and some additional
/// helpful information like file and line number.
///
/// # Example
/// [`log_debug!`](crate::log_debug) can be used to pring out a [`Debug`](crate::logger::types::logger::LogSeverity::Debug) message
/// to the console:
/// ```rust
...
/// which will provide the [`Info`](crate::logger::types::logger::LogSeverity::Info) log severity level and some additional
/// helpful information like file and line number.
///
/// # Example
/// [`log_info!`](crate::log_info) can be used to pring out an [`Info`](crate::logger::types::logger::LogSeverity::Info)
...
/// which will provide the [`Warning`](crate::logger::types::logger::LogSeverity::Warning) log severity level and some additional
/// helpful information like file and line number.
///
/// # Example
/// [`log_warn!`](crate::log_warn) can be used to pring out a [`Warning`](crate::logger::types::logger::LogSeverity::Warning)
/// message to the console:
/// ```rust
/// use rquant::log_warn;
///
...
/// which will provide the [`Error`](crate::logger::types::logger::LogSeverity::Error) log severity level and some additional
/// helpful information like file and line number.
///
/// # Example
/// [`log_error!`](crate::log_error) can be used to pring out an [`Error`](crate::logger::types::logger::LogSeverity::Error)
/// message to the console:
/// ```rust
